...
if (file_exists($libpath . '/cmb2/init.php')) {
    require_once $libpath . '/CMB2/init.php';
} elseif (file_exists($libpath . '/CMB2/init.php')) {
    require_once $libpath . '/CMB2/init.php';
}
 ...
 */
require_once($libpath . '/cmb2_field_ajax_search/cmb2-field-ajax-search.php');
require_once($libpath . '/cmb2_field_map/cmb-field-map.php');
require_once($libpath . '/cmb2-conditionals/cmb2-conditionals.php');
...
//        'title' => esc_html__('Workout Meta', 'cmb2'),
    ...
    $cmb_workout->add_field(array(
        ...
        'type' => 'taxonomy_radio',
        'taxonomy' => 'ao',
//        'show_option_none' => 'Custom Location'
        'show_option_none' => 'Other'
    ));
...
//            'data-conditional-id' => $prefix . 'wo_ao',
...
function f3_register_taxonomy_metabox()
{
    ...
    $cmb_ao_tax->add_field(array(
        'name' => 'Thumbnail',
        'desc' => 'Add a thumbnail to this AO',
        'id' => 'thumb',
        'type' => 'file',
        'options' => array(
