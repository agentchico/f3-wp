                ...
                if (isset($value) && !empty($value)) {
                    ...
                    foreach ($value as $val) :
                        ...
                        <li>
                            ...
                            <a href="<?php echo $this->object_link($field_name, $val, $object_to_search); ?>"
        ...
        public function display($pre_output, $field, $display)
        {
            ...
            if (is_array($field->value)) : ?>
                <?php foreach ($field->value as $value) : ?>
                    <a href="<?php echo $this->object_link($field->args['id'], $value, $object_type); ?>"
                       class="edit-link">
                        <?php echo $this->object_text($field->args['id'], $value, $object_type); ?>
                    </a> <br>
                <?php endforeach; ?>
            <?php else : ?>
                <a href="<?php echo $this->object_link($field->args['id'], $field->value, $object_type); ?>"
                   class="edit-link">
        ...
        public function get_results()
        {
            ...
            if (!wp_verify_nonce($nonce, 'cmb_ajax_search_get_results')) {
                ...
                foreach ($results as $result) :
                    ...
                    if ($showCreate && $result->user_login == $_POST['query']) {
                        $showCreate = false;
                    }
                ...
                if ($showCreate) {
                    $data[] = array(
                        'id' => $_POST['query'],
                        'value' => $_POST['query'] . ' (Not registered)',
                        'link' => ''
                    );
                }
